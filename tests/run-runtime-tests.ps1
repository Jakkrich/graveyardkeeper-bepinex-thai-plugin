...
$files = @((Join-Path $PSScriptRoot 'RuntimeTests.cs'), (Join-Path $mod 'GK2Thai.Plugin/Runtime/EmbeddedPayload.cs'), (Join-Path $mod 'GK2Thai.Plugin/Runtime/ThaiGlyphMetrics.cs'))
